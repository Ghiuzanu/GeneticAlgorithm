...
int main() {
    ...
    int dim, prec, etape;
    double a, b, x, y, z, probRecomb, probMut;
    srand(time(NULL));
    ...
    for (int i = 0; i < participa.size() - 1; ++i) {
        ...
        if (j == participa.size() - 1){
            ...
            valx[participa[i].second] = (b - a) / 4194303 * aux + a;
            ...
            valx[participa[j].second] = (b - a) / 4194303 * aux + a;
